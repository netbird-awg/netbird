...
func (p *program) Start(svc service.Service) error {
	...
	log.Info("starting NetBird-AWG service") //nolint
...
func (p *program) Stop(srv service.Service) error {
	...
	log.Info("stopped NetBird-AWG service") //nolint
	return nil
}
...
var runCmd = &cobra.Command{
	Use:   "run",
	Short: "runs NetBird-AWG as service",
...
var startCmd = &cobra.Command{
	Use:   "start",
	Short: "starts NetBird-AWG service",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel, false)
		if err != nil {
		...
		cmd.Println("NetBird-AWG service has been started")
		return nil
	},
}
...
var stopCmd = &cobra.Command{
	Use:   "stop",
	Short: "stops NetBird-AWG service",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel, false)
		if err != nil {
		...
		cmd.Println("NetBird-AWG service has been stopped")
		return nil
	},
}
...
var restartCmd = &cobra.Command{
	Use:   "restart",
	Short: "restarts NetBird-AWG service",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel, false)
		if err != nil {
		...
		cmd.Println("NetBird-AWG service has been restarted")
		return nil
	},
}
...
var svcStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "shows NetBird-AWG service status",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		...
		cmd.Printf("NetBird-AWG service status: %s\n", statusText)
		return nil
	},
}
