...
var routesListCmd = &cobra.Command{
	...
	Aliases: []string{"ls"},
	Short:   "List networks",
	Example: "  netibird-awg networks list",
...
var routesSelectCmd = &cobra.Command{
	...
	Example: "  netibird-awg networks select all\n  netibird-awg networks select route1 route2\n  netibird-awg routes select -a route3",
...
var routesDeselectCmd = &cobra.Command{
	...
	Example: "  netibird-awg networks deselect all\n  netibird-awg networks deselect route1 route2",
	Args:    cobra.MinimumNArgs(1),
