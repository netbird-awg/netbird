# Translating the NetBird-AWG UI
...
**Tier A — never translate (brands):** `NetBird-AWG` · `WireGuard®` · `Rosenpass` · `GitHub` · `ICE` · company/product names · sample URLs · version numbers.
