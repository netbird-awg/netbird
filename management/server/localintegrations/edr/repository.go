...
//nolint:nilnil // A nil integration means that the account has no enabled provider.
...
//nolint:nilnil // A nil device means that no unique serial or hostname match exists.
